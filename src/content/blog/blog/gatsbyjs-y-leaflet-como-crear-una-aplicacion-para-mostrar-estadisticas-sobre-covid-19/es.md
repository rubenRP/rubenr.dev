...
taxonomy:
  ...
  tag:
    ...
    - React
    - GatsbyJS
hero_image: /img/content/covid-map-coronavirus-app.jpg
thumbnail: /img/content/covid-map-thumbnail.jpg
_locale: es
---
...
![Covid App Status](/img/content/covid-map-app.jpg)
...
![Gatsby Home Example](/img/content/covid-map-gatsby-home-example.jpg)
...
![COVID-19 App File Structure Example](/img/content/covid-map-file-structure.jpg)
...
![COVID-19 App Video Example](/img/content/covid-map-video-post.gif)
